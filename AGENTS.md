...
**Remaining:** SmarterASP deployment DONE 2026-09-26 (see the runbook's deployment record; machineKey rotated). Open: human verification (admin login, edit a post), delete the ftp backup when satisfied, then investigate the two 2026-08-15 `deploy Error` entries. Do not otherwise modify this repo unless asked.
